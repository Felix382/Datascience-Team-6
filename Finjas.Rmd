...
Dummy_Feiertag<- read_excel("data/Vor_Nachfeiertage.xlsx")
View(Dummy_Feiertag)
...
merger4<-left_join(merger3,Dummy_Feiertag)
final<-left_join(merger4, wetter)
...
Lineare Regression
```{r}
mod<- lm(Umsatz~KielerWoche+ Ferien+ wochentag + Holidays + Temperatur+as.factor(Warengruppe)+ Bewoelkung+ Vor+ Nach,final)
summary(mod)
