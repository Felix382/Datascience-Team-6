...
Sonnenscheindauer <- read_csv("data/Sonnenscheindauer.csv")
...
merger1_1<-left_join(Niederschlagsmenge,Niederschlag)
merger1_2<-left_join(merger1_1, Sonnenscheindauer)
...
```{r}
#View(final)
mod<- lm(Umsatz~KielerWoche+ Ferien+ wochentag + Holidays + Temperatur+as.factor(Warengruppe), final)
summary(mod)
