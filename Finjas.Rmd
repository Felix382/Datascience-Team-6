...
final_predict <- rbind(final[2116,], final[4232,], final[6348,], final[8410,], final[10526,])
...
```{r}
#predict 01.06.2018
predictions_norm <- py$model$predict(final_predict)


final_predict = as.data.frame(final_predict)
pred_test <- predict(train_predictions, final_predict)
